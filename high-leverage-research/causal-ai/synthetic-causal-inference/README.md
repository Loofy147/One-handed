# NS-Causal Inference Synthetic Dataset
...
## Usability
- **Primary Use Case**: Benchmarking causal discovery and structural equation modeling.
- **Data Format**: CSV with treatment, outcome, and confounding variables.
- **Accessibility**: Available on Hugging Face as `REZ3LIET/NS-Causal-Inference-Synthetic`.

## Usage
```python
from datasets import load_dataset
dataset = load_dataset("REZ3LIET/NS-Causal-Inference-Synthetic")
```
